...
//
const BotName = 'Ganti Bucin'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/akbarrizki93_'; // Nama Instagramlu cok
const whatsapplu = '0822-8783-9936'; // Nomor whatsapplu cok
